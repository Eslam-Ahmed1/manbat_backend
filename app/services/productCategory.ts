...
export const createCategory = async (data: { name: string; description?: string; image_url?: string }) => {
...
export const updateCategory = async (id: string, data: { name?: string; description?: string; image_url?: string }) => {
    if (data.name) {
